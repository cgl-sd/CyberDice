...
- 技术路线收敛为 Vela 原生页面 UI 加平台无关的 CommonJS 逻辑模块：首页骰子、结果、提示和“功能”入口样式改由 `pages/home/home.ux` 独立持有，不再通过共享样式或 `transform` 影响关键 Flex 布局。矩形大屏入口维持原始 16px 底边距；胶囊屏仍使用独立 80px 安全边距。
